...
public class Bank {
    ...
    private static final Street[][] streets = {
            ...
            },
            {
                ...
                new Street("вул. Ярославів вал", 330, new int[]{33, 165, 495, 975, 1450, 1600}, 220, 230, 230, "magenta"),
                new Street("вул. Л. Українки", 340, new int[]{34, 170, 510, 1025, 1530, 1700}, 230, 240, 240, "magenta")
            }
